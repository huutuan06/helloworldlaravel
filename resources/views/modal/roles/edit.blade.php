 ...
 */
?>
<div class="modal fade" id="roleModalEdit">
                    ...
                    <div class="row titleForm">
                        ...
                        <div class="col-md-8">
                            <div  style="margin-top: 15px;">
                                ...
                                <p class="mediumTitleForm">Request for Updating Role</p>
                            </div>
                        </div>
                    </div>
                </div>
                <form id="roleFormEdit" class="form-horizontal form-label-left">
                    {{ csrf_field() }}
                    <div class="form-group" style="margin-top: 30px;">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Role name: </label>
                        <div class="col-md9 col-sm-9 col-xs-12">
                            <input class="form-control nameTopic" name="rolename" id="_rolename" placeholder="" type="text">
