 ...
 */
?>
<div class="modal fade" id="permissionModalEdit">
                    ...
                    <div class="row titleForm">
                        ...
                        <div class="col-md-8">
                            <div  style="margin-top: 15px;">
                                ...
                                <p class="mediumTitleForm">Request for Updating Permission</p>
                            </div>
                        </div>
                    </div>
                </div>
                <form id="permissionFormEdit" class="form-horizontal form-label-left">
                    {{ csrf_field() }}
                    <div class="form-group" style="margin-top: 30px;">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Permission name: </label>
                        <div class="col-md9 col-sm-9 col-xs-12">
                            <input class="form-control nameTopic" name="permissionname" id="_permissionname" placeholder="" type="text">
                            <input type="hidden" name="permissionid" id="permissionID">
                        </div>
                    </div>
                    <div class="modal-footer"  style="border: none;">
                        <div class="pull-right">
                            <input class="form-control btnControlForm" type="submit" value="Update">
                        </div>
